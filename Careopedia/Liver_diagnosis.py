...
class liver(Tk):
    def __init__(self):
        def detection():
            ...
            try:
                input_data = (e1, e3, e4, e5, e6, e7, e8, e9, e10, e11, e11, e12, e13)
                ...
                if prediction[0] == 0:
                    messagebox.showinfo("Diseases report", "The person does not have Liver Disease")
                    print("The person does not have Liver Disease")
                    sql = "UPDATE user SET liver_diseases ='NO' WHERE mr_no = '"+e11+"'"
                    mycursor.execute(sql)
                    mydb.commit()
                else:
                    messagebox.showinfo("Diseases report", "The person have Liver Disease")
                    print('The person have Liver Disease')
                    sql = "UPDATE user SET liver_diseases ='YES' WHERE mr_no = '"+e11+"' "
                    mycursor.execute(sql)
                    mydb.commit()
        ...
        label =Label(root,text="LIVER DISEASE DIAGNOSIS", justify=CENTER, font=("Arial", 40, "italic", "bold", "underline"), bg='pink', bd= 20)
        label.place(x=400,y=25)

        # picture label

        pic2 = tkinter.PhotoImage(file="liver_symptoms.png")
        pic2label = tkinter.Label(root, image=pic2, width=550, height=635)
        pic2label.place(x=900, y=140)
        ...
        label_2 =Label(root,text="Gender", width=25, bg='pink',font=("arial",12, "italic", "bold"))
...
##        Radiobutton(root,text="Other",padx= 20, variable= var, value=3, bg='pink', font=("arial",10, "italic", "bold")).place(x=690,y=230)
        ...
        label_3 =Label(root,text="Total_Bilirubin", width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_3.place(x=150,y=280)

        entry_3=Entry(root, width= 25, bd=5)
        entry_3.place(x=500,y=280)

        label_4=Label(root,text="Direct_Bilirubin",width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_4.place(x=150,y=320)

        entry_4=Entry(root, width= 25, bd=5)
        entry_4.place(x=500,y=320)

        label_5=Label(root,text="Alkaline_Phosphotase",width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_5.place(x=150,y=360)

        entry_5=Entry(root, width= 25, bd=5)
        entry_5.place(x=500,y=360)

        label_6=Label(root,text="Alamine_Aminotransferase",width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_6.place(x=150,y=400)

        entry_6=Entry(root, width= 25, bd=5)
        entry_6.place(x=500,y=400)

        label_7=Label(root,text="Aspartate_Aminotransferase",width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_7.place(x=150,y=440)

        entry_7=Entry(root, width= 25, bd=5)
        entry_7.place(x=500,y=440)

        label_8=Label(root,text="Total_Protiens",width=25, bg='pink',font=("arial",12, "italic", "bold"))
        label_8.place(x=150,y=480)

        entry_8=Entry(root, width= 25, bd=5)
        entry_8.place(x=500,y=480)

        label_9=Label(root,text="Albumin",width=25, bg='pink',font=('arial',12, "italic", "bold"))
        label_9.place(x=150,y=520)

        entry_9=Entry(root, width= 25, bd=5)
        entry_9.place(x=500,y=520)

        label_10=Label(root,text="Albumin_and_Globulin_Ratio",width=25, bg='pink',font=('arial',12, "italic", "bold"))
        ...
        label_12 = Label(root, text="Number of Major Vessels", width=25, bg='pink',
