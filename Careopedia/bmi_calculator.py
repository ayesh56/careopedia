...
application.config(background='pink')

def BodyMassIndex_Calculator(self):
...
font=("arial", 54, 'bold'), bg="pink", relief='raise', width=32, height=1)
lbl_T1.pack()
...
lbl_res_bmi = Label(frame1B, padx=16, pady=16, bd=16, fg='#000000', font=('arial', 30, 'bold'), bg='pink',
...
BMI_BUTTON = Button(frame2, text="Click to \nCheck Your \nBMI", padx=8, pady=8, bd=12, bg='pink', width=21,
